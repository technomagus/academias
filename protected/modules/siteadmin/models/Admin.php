...
class Admin extends CActiveRecord
{
	...
	public function searchDesligado()
	{
        ...
        public function beforeSave() {
            $this->adm_senha = md5($this->adm_senha);
            return parent::beforeSave();
        }
        public function aGetNiveis(){
            return array(
                0=> 'Master',
                1=> 'Visualizar',
                2=> 'Financeiro',
        ...
        public function aGetNomeNivel()
        {
            $aNiveis = self::aGetNiveis();
            return $aNiveis[$this->adm_nivel];
